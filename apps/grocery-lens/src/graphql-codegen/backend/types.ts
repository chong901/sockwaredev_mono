...
export type GroceryItemResolvers<
  ContextType = ApolloContext,
  ParentType extends
    ResolversParentTypes["GroceryItem"] = ResolversParentTypes["GroceryItem"],
> = ResolversObject<{
...
> = ResolversObject<{
  addGroceryItem?: Resolver<
    ResolversTypes["GroceryItem"],
    ParentType,
    ContextType,
    RequireFields<MutationAddGroceryItemArgs, "input">
  >;
  addLabel?: Resolver<
    ResolversTypes["Label"],
    ParentType,
    ContextType,
    RequireFields<MutationAddLabelArgs, "name">
  >;
  addStore?: Resolver<
    ResolversTypes["Store"],
    ParentType,
    ContextType,
    RequireFields<MutationAddStoreArgs, "name">
  >;
  deleteGroceryItem?: Resolver<
    ResolversTypes["GroceryItem"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteGroceryItemArgs, "id">
  >;
  updateGroceryItem?: Resolver<
    ResolversTypes["GroceryItem"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateGroceryItemArgs, "id" | "input">
  >;
}>;
...
> = ResolversObject<{
  getGroceryItems?: Resolver<
    Array<ResolversTypes["GroceryItem"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetGroceryItemsArgs, "filter">
  >;
