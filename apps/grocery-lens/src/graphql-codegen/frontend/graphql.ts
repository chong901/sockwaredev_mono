...
export type GroceryItemFragmentFragment = { __typename?: 'GroceryItem', id: string, name: string, price: number, quantity: number, pricePerUnit: number, unit: string, notes?: string | null, url?: string | null, created_at: any, url_preview_image?: string | null, store: { __typename?: 'Store', id: string, name: string }, labels: Array<{ __typename?: 'Label', id: string, name: string }> };
...
export type AddGroceryItemMutation = { __typename?: 'Mutation', addGroceryItem: { __typename?: 'GroceryItem', id: string, name: string, price: number, quantity: number, pricePerUnit: number, unit: string, notes?: string | null, url?: string | null, created_at: any, url_preview_image?: string | null, store: { __typename?: 'Store', id: string, name: string }, labels: Array<{ __typename?: 'Label', id: string, name: string }> } };
...
export type UpdateGroceryItemMutation = { __typename?: 'Mutation', updateGroceryItem: { __typename?: 'GroceryItem', id: string, name: string, price: number, quantity: number, pricePerUnit: number, unit: string, notes?: string | null, url?: string | null, created_at: any, url_preview_image?: string | null, store: { __typename?: 'Store', id: string, name: string }, labels: Array<{ __typename?: 'Label', id: string, name: string }> } };
...
export type GetGroceryItemsQuery = { __typename?: 'Query', getGroceryItems: Array<{ __typename?: 'GroceryItem', id: string, name: string, price: number, quantity: number, pricePerUnit: number, unit: string, notes?: string | null, url?: string | null, created_at: any, url_preview_image?: string | null, store: { __typename?: 'Store', id: string, name: string }, labels: Array<{ __typename?: 'Label', id: string, name: string }> }> };
