...
export type AddLabelMutation = {
  __typename?: "Mutation";
  addLabel: { __typename?: "Label"; id: string; name: string };
};
...
export type AddStoreMutation = {
  __typename?: "Mutation";
  addStore: { __typename?: "Store"; id: string; name: string };
};
...
export type AddGroceryItemMutation = {
  ...
  addGroceryItem: {
    ...
    unit: string;
    notes?: string | null;
    store: { __typename?: "Store"; name: string };
    labels: Array<{ __typename?: "Label"; name: string }>;
  };
};
...
export type DeleteGroceryItemMutation = {
  __typename?: "Mutation";
  deleteGroceryItem: { __typename?: "GroceryItem"; id: string };
};
...
export type GetStoresQuery = {
  __typename?: "Query";
  getStores: Array<{ __typename?: "Store"; id: string; name: string }>;
};
...
export type GetLabelsQuery = {
  __typename?: "Query";
  getLabels: Array<{ __typename?: "Label"; id: string; name: string }>;
};
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateGroceryItemInput" },
            },
          },
        },
      ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "GroceryItemFilter" },
            },
          },
        },
      ],
