...
export const BusMarker = ({
  ...
  return (
    <Marker
      ...
      icon={divIcon({
        html: `
        <div class="group !bg-slate-500 hover:!bg-slate-600 !rounded-full !w-12 !h-12 !flex !justify-center !items-center !text-xl text-slate-200 !z-[9990] hover:!z-[9999] flex-col border-red-white border-2">
          <div class="${color}">
            ${arrivalTime}
          </div>
          <div class="text-xs">
        ...
        className:
          "!bg-slate-500 hover:!bg-slate-600 !rounded-full !w-12 !h-12 !flex !justify-center !items-center !text-xl text-slate-200 hover:!z-[9999] !z-[9990]",
      })}
    />
  );
};
