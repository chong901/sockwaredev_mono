...
export type BusArrivalResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["BusArrival"] = ResolversParentTypes["BusArrival"],
> = ResolversObject<{
...
export type BusArrivalDataResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["BusArrivalData"] = ResolversParentTypes["BusArrivalData"],
> = ResolversObject<{
...
export type BusStopResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["BusStop"] = ResolversParentTypes["BusStop"],
> = ResolversObject<{
...
> = ResolversObject<{
  getBusArrival?: Resolver<
    ResolversTypes["BusArrivalData"],
    ParentType,
    ContextType,
    RequireFields<QueryGetBusArrivalArgs, "code">
  >;
  getBusStops?: Resolver<
    Array<ResolversTypes["BusStop"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetBusStopsArgs, "lat" | "long">
  >;
  getNearestBusStops?: Resolver<
    ResolversTypes["BusStop"],
    ParentType,
    ContextType,
    RequireFields<QueryGetNearestBusStopsArgs, "lat" | "long">
  >;
  searchBusStops?: Resolver<
    Array<ResolversTypes["BusStop"]>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchBusStopsArgs, "search">
  >;
}>;
...
> = ResolversObject<{
  NextBus?: Resolver<
    Maybe<ResolversTypes["BusArrival"]>,
    ParentType,
    ContextType
  >;
  NextBus2?: Resolver<
